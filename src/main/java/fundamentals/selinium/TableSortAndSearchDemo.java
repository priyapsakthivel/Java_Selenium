...
public class TableSortAndSearchDemo {
    public static void main(String[] args) {
        System.out.println("please enter show results filter number");
        System.out.println("please enter what you are searching");
        ...
        webDriver.findElement(By.id("example_length")).click();
    }
}
